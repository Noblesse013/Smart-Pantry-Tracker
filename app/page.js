...
const EDAMAM_APP_ID = 'bf33db7b';
const EDAMAM_APP_KEY = 'cf1a1a00434f5e8509bcd177087c83c0';
...
//             top="50%"
//             left="50%"
//             sx={{ transform: "translate(-50%, -50%)", width: '90%', maxWidth: 800, bgcolor: "background.paper", borderRadius: 1, boxShadow: 24, p: 4 }}
//           >
//             <Typography variant="h6" color="textPrimary" mb={2}>
//               Recipe Suggestions
//             </Typography>
...
//               ) : (
//                 recipes.map((recipe) => (
//                   <ListItem key={recipe.uri} button component="a" href={recipe.url} target="_blank">
//                     <ListItemText
//                       primary={recipe.label}
//                       secondary={`Ingredients: ${recipe.ingredientLines.join(', ')}`}
//                     />
//                   </ListItem>
//                 ))
//               )}
